...
import { Menu, X, Phone, Mail, MapPin, ArrowRight, Facebook, Instagram, Twitter, Key, Droplet, Wrench, Hammer, Calendar, ChevronUp } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  const services = [
    { 
      id: 1, 
      name: 'Key Cutting', 
      description: 'Professional key cutting service with quick turnaround times and competitive pricing. We can duplicate most residential, commercial, and automotive keys.',
      icon: <Key size={40} />,
      ...
      id: 2, 
      name: 'Labour', 
      description: 'We have an arsenal of professional plumbers, painters, carpenters, electricians and many more. We are more than glad to connect you with workmen and women who are tested, approved and trusted.',
      icon: <Key size={40} />,
      image: '/api/placeholder/600/400',
      benefits: [
    ...
    { 
      id: 3, 
      name: 'Paint Mixing', 
      description: 'Custom paint mixing services with thousands of colors to choose from for your project. Our computerized system ensures perfect color matching every time.',
    ...
    { 
      ...
      description: 'Our skilled technicians can repair a wide range of tools and equipment, extending their lifespan and saving you money.',
      icon: <Wrench size={40} />,
      image: '/api/placeholder/600/400',
      benefits: [
    ...
    { 
      id: 5, 
      name: 'DIY Workshops', 
      description: 'Learn new skills with our regular DIY workshops taught by experienced professionals. Topics range from basic home repairs to advanced woodworking.',
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto py-4 px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex font-semibold items-center space-x-8">
              ...
              <a href="./services" className="text-yellow-400 hover:text-white">Services</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-700 px-4">
            <nav className="flex flex-col space-y-2 my-4">
              ...
              <a href="./services" className="py-2 px-4 hover:bg-gray-600 rounded text-yellow-500">Services</a>
      ...
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-lg max-w-2xl">At Tremont Hardware, we offer a wide range of professional services to help you complete your projects with confidence. Our trained partners are ready to assist with everything you need.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map(service => (
              <div key={service.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300 flex flex-col">
                  ...
                  <ul className="text-gray-600 space-y-1 mb-6">
                    {service.benefits.map((benefit, index) => (
                      <li key={index} className="flex items-start">
                        <ArrowRight size={16} className="text-yellow-500 mr-2 mt-1 flex-shrink-0" />
                        <span>{benefit}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Allied Place, Sheikh Karmue Rd <br />Naiobi, KE</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-yellow-500">
              ...
              <p className="text-gray-600">"I'm amazed at how perfectly they matched my paint color from just a tiny chip! Their computerized system is impressive, and the quality of the paint is excellent."</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-yellow-500">
              ...
              <p className="text-gray-600">"I've taken three of their DIY workshops so far. The instructors are so knowledgeable and patient. I've learned skills I use all the time now around my house."</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold mb-3">How quickly can you cut keys?</h3>
              <p className="text-gray-600">Most standard keys can be cut while you wait, typically in less than 5 minutes per key. Specialized or high-security keys may take longer or require ordering.</p>
            </div>
            
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold mb-3">How do I sign up for DIY workshops?</h3>
              <p className="text-gray-600">You can register for workshops in-store, by phone, or through our website. Payment is required at registration to secure your spot, as class sizes are limited.</p>
            </div>
            
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold mb-3">Do you offer delivery for rental equipment?</h3>
              <p className="text-gray-600">Yes, we offer delivery and pickup for larger rental items within a 15-mile radius of our store. Delivery fees vary based on distance and equipment size.</p>
            </div>
          </div>
        </div>
      </section>
