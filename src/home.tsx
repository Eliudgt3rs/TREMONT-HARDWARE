        ...
        <div className="container mx-auto px-4 py-10 md:py-20 flex flex-col md:flex-row">
          <div className="md:w-1/2 mb-2 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Quality Products and Tools for Every Project
            </h1>
            <p className="text-lg mb-8">
              Tremont Hardware has everything you need to get the job done
              right.
            </p>
            <div className="flex flex-wrap gap-4">
              <a
                href="./products"
                className="bg-yellow-500 hover:bg-gray-900 hover:scale-110 hover:text-yellow-500 text-gray-900 font-semibold px-6 py-3 rounded-4xl transition duration-300 flex items-center"
              >
                Shop Now <ArrowRight size={16} className="ml-2" />
              </a>
              <button
                onClick={handleCall}
                className="bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 hover:scale-110 text-white font-semibold px-6 py-3 rounded-4xl transition duration-300"
              >
                Call Now
              </button>
            </div>
            ...
            {categories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-medium text-gray-800 group-hover:text-yellow-600">
                    {category.name}
                  </h3>
                </a>
              );
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold hover:text-amber-600 duration-300">
              Our Customers' Favorite Products
            </h2>
            <a
              href="./products"
              className="text-yellow-600 hover:text-yellow-600 font-medium flex items-center hover:scale-y-105 duration-300"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-700 rounded-lg p-6 hover:bg-gray-600 transition duration-300">
              ...
              <p className="text-gray-300 mb-4">
                Professional key cutting service with quick turnaround times and
                competitive pricing.
              </p>
              <a
                href="./services"
            ...
            <div className="bg-gray-700 rounded-lg p-6 hover:bg-gray-600 transition duration-300">
              ...
              <p className="text-gray-300 mb-4">
                Custom paint mixing services with thousands of colors to choose
            ...
            <div className="bg-gray-700 rounded-lg p-6 hover:bg-gray-600 transition duration-300">
              ...
              <p className="text-gray-300 mb-4">
                Rent professional-grade tools for your home improvement projects
                at affordable rates.
              </p>
              <a
                href="./services"
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-800 text-lg">
              Subscribe to our newsletter for exclusive deals and DIY tips.
            </p>
          </div>
