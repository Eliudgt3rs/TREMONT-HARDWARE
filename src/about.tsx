...
export default function AboutPage() {
  ...
  const teamMembers = [
    {
      ...
      image: "",
      bio: "Started Tremont Hardware in 2016 with a vision to provide quality tools and exceptional service to the community.",
    },
    {
      name: "Sarah Johnson",
      position: "General Manager",
      image: "",
      bio: "With 15 years of experience in retail management, Sarah ensures our store operations run smoothly and efficiently.",
    },
  ];
  ...
  const milestones = [
    {
      ...
      title: "Grand Opening",
      description:
        "Tremont Hardware opened its doors for the first time along Luthuli Lane.",
    },
    {
      year: "2019",
      title: "Expansion",
      description:
        "Expanded our store to include a wider range of products and services.",
    },
    {
      year: "2020",
      title: "Modern Renovation",
      description:
        "Completely renovated our store with modern fixtures and improved layout.",
    },
    {
      year: "2025",
      title: "Online Presence",
      description:
        "Launched our first website to reach customers beyond our local community.",
    },
    {
      year: "2026",
      title: "10th Anniversary",
      description:
        " We shall Celebrate a decade of service with a community event and special promotions.",
    },
  ];
  ...
  const values = [
    ...
    {
      title: "Expertise",
      icon: <Hammer size={32} className="text-yellow-500" />,
      description:
        "Our staff are knowledgeable and trained to help with any project.",
    },
    {
      title: "Community",
      icon: <Users size={32} className="text-yellow-500" />,
      description:
        "We're proud to be a part of the Tremont community for close to 10 years.",
    },
    {
      title: "Service",
      icon: <Clock size={32} className="text-yellow-500" />,
      description:
        "We provide prompt, friendly service to every customer who walks through our doors.",
    },
  ];
        ...
        <div className="container mx-auto py-4 px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center font-semibold space-x-8">
              ...
              <a href="./about" className="text-yellow-400 hover:text-white">
                About
              </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-700 px-4">
            <nav className="flex flex-col space-y-2 my-4">
              ...
              <a
                href="./about"
                className="py-2 px-4 hover:bg-gray-600 rounded text-yellow-400"
              >
                About
              </a>
              <a
      ...
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            About Tremont Hardware
          </h1>
          <p className="text-lg max-w-3xl mx-auto">
            Your trusted neighborhood hardware store serving the Tremont
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                Tremont Hardware was founded in 2016 by Elijah Muriuki, a former
                contractor who saw the need for a local hardware store that
                truly understood the needs of professionals and homeowners
                alike.
              </p>
              <p className="text-gray-700 mb-4">
                What started as a small shop with basic tools and supplies has
                grown into a comprehensive hardware destination, offering lots
                of products, expert advice, and specialized services to help our
                customers tackle projects of any size.
              </p>
              <p className="text-gray-700">
                Through economic ups and downs, technological changes, and
                shifts in the retail landscape, our commitment to quality,
                service, and community has remained unwavering. We believe in
                being more than just a store – we're your project partners.
              </p>
            </div>
          </div>
        </div>
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="md:w-1/6 mb-4 md:mb-0">
                  <span className="bg-yellow-500 text-gray-900 font-bold py-2 px-4 rounded-lg">
                    {milestone.year}
                  </span>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-100 rounded-lg p-6 relative">
              <div className="text-yellow-500 text-4xl font-serif absolute top-4 left-4">
                "
              </div>
              <p className="text-gray-700 mb-4 pt-6">
                The staff at Tremont Hardware are always so helpful. They helped
                me find exactly what I needed for my bathroom renovation project
                and even gave me tips on installation.
              </p>
              <div className="flex items-center">
                <div>
                  <p className="font-semibold">John P.</p>
                  <p className="text-sm text-gray-500">
                    Loyal customer since 2017
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 relative">
              ...
              <p className="text-gray-700 mb-4 pt-6">
                I've been shopping at Tremont Hardware for over 6 years. Their
                product selection is unmatched and the quality is always
                top-notch. It's the only hardware store I trust.
              </p>
              <div className="flex items-center">
                <div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 relative">
              ...
              <p className="text-gray-700 mb-4 pt-6">
                As a first-time homeowner, I was overwhelmed by all the tools I
                needed. The team at Tremont took the time to walk me through
                everything and helped me build my essential toolkit.
              </p>
              <div className="flex items-center">
                <div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                At Tremont Hardware, we believe in giving back to the community
                that has supported us for close to a decade. Each year, we
                organize and participate in various community events and
                initiatives.
              </p>
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    Sponsor of the Tremont Community Bursery
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="bg-yellow-500 p-1 rounded-full mr-3 mt-1">
                  ...
                  <p className="text-gray-700">
                    Tool donation program for vocational training
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="bg-yellow-500 p-1 rounded-full mr-3 mt-1">
                  ...
                  <p className="text-gray-700">
                    Volunteer home repair services for elderly residents
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 bg-yellow-500">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-800 text-lg mb-8 max-w-3xl mx-auto">
            Experience the Tremont Hardware difference. Our knowledgeable staff
            is ready to help with your next project, big or small.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="./contacts"
              className="bg-gray-800 hover:bg-gray-900 text-white font-semibold px-6 py-3 rounded-lg transition duration-300"
            >
              Find Our Store
            </a>
          </div>
